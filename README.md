...
ENHANCED ENCODER-DECODER  PROGRAM

https://lowellcross.github.io/Encoder-Decoder/


<img width="469" height="469" alt="image" src="https://github.com/user-attachments/assets/fbbfeb72-b269-4579-a30a-891605f509b9" />


 
INTRODUCTION

ENHANCED ENCODER-DECODER  PROGRAM is a GUI utility that encodes alpha numeric characters into a code that requires the decoder to restore it. There is a  choice of  using a Shift Cipher  code or   using Morse code.  This 

program has AI  built into  it to guide  the user in using  this successfully. One example is when you utilize the Morse code  function the AI assistant  will alert you  if  you use lower case characters to encode. The 

output  will not be affected but the program is  designed for upper case Morse.

FEATURES

•	Real-time monitoring from AI assistant to help you with  comments  on which code  to use for your project.

•	Multiple output modes – Encoding can be done in a Shift cipher  code using   any  security  key of your  choice,  or encoded  into Morse. The  decoding process  is simply putting the  code into the input screen and 
